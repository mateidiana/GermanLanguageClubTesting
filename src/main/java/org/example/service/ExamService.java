...
public class ExamService {
    ...
    private final IRepository<Vocabulary> vocabularyRepo;
    private final IRepository<Reading> readingRepo;


    public ExamService(IRepository<Exam> examRepo, IRepository<Student> studentRepo, IRepository<Teacher> teacherRepo, IRepository<Grammar> grammarRepo,
                       IRepository<Writing> writingRepo, IRepository<Vocabulary> vocabularyRepo,
                       IRepository<Reading> readingRepo) {
    ...
    public void takeGrammarExam(Integer studentId, Integer examId) {
        ...
        if (foundCourse == 1) {
            ...
            if (correctAnswers > 5)
                System.out.println("You have passed this exam with the grade " + correctAnswers + "!");
    ...
    public void takeVocabExam(Integer studentId, Integer examId) {
        ...
        if (foundCourse == 1) {
            ...
            if (correctAnswers > 5)
                System.out.println("You have passed this practice test with the grade " + correctAnswers + "!");
    ...
    public void sortStudentsByGrammarGrades(Integer examId) {
        ...
        for (Student student : students) {
            ...
            float average = 0;
            int contor = 0;
            for (Map.Entry<Integer, Float> entry : grammarResults.entrySet()) {
